...
public struct StorageService {
	...
	public let markAudioFileAsNotListened: (Book, AudioFile) -> Void
	...
	public init(
		...
		markAudioFileAsNotListened: @escaping (Book, AudioFile) -> Void
	) {
		...
		self.markAudioFileAsNotListened = markAudioFileAsNotListened
	}
}
